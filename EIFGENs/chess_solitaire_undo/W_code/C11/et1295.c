...
extern void F1295_11752(EIF_REFERENCE);
extern void F1295_11753(EIF_REFERENCE);
...
extern void F1295_11757(EIF_REFERENCE);
extern void F1295_11758(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1295_11752 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9022, 0xF80003D1, 0); /* business_obj */
	...
	*(EIF_REFERENCE *)(Current + RTWA(9022, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 9023, 0xF80000B7, 0); /* session_file */
	...
	*(EIF_REFERENCE *)(Current + RTWA(9023, dtype)) = (EIF_REFERENCE) tr1;
	...
	ur1 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9132, "insert_text", tr1))(tr1, ur1x);
	RTHOOK(4);
...
void F1295_11753 (EIF_REFERENCE Current)
{
	GTCX
...
{
	GTCX
	RTOTC (F1295_11756,18437,RTMS_EX_H("./session.txt",13,1379049588));
}

/* {ETF_MAIN_WINDOW}.clear_display */
void F1295_11757 (EIF_REFERENCE Current)
{
	GTCX
...
void F1295_11758 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1294, Current, 1, 1, 18438);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	for (;;) {
		...
		ur1 = RTCCL(tr2);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(9133, "append_text", tr1))(tr1, ur1x);
		RTHOOK(5);
...
void F1295_11759 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1294, Current, 0, 0, 18439);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9000, dtype))(Current);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1294, Current, 1, 0, 18440);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1294, Current, 0, 0, 18441);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1294, Current, 2, 0, 18442);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1294, Current, 5, 1, 18443);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
