...
static EIF_TYPED_VALUE F1013_8719_body(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6498, 0xF800047C, 0); /* caret_move_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6499, 0xF8000482, 0); /* selection_change_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
#define up1 up1x.it_p
	...
	if (EIF_TEST(loc1)) {
		...
		Result = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(4);
		RTDBGAA(Current, dtype, 6500, 0xF800047C, 0); /* file_access_actions_internal */
		tr1 = RTCCL(Result);
		RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1013_8719_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1012, Current, 0, 0, 15033);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1013_8719 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6498, Dtype(Current), Dftype(Current)))) {
			GTCX
			RTLD;
			RTLI(1);
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1013_8719_body (Current)).it_r;
			*(EIF_REFERENCE *)(Current + RTWA(6498,Dtype(Current))) = r.it_r;
			RTAR(Current, r.it_r);
			RTLE;
		}
	}
