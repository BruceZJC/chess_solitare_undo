...
static const EIF_TYPE_INDEX egt_15_1013 [] = {0xFF01,1148,0xFFFF};
...
static const struct desc_info desc_1013[] = {
	...
	{EIF_GENERIC(egt_14_1013), 15031, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1013), 15032, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x08F9 /*1148*/), 15033, 0},
	{EIF_NON_GENERIC(0x0905 /*1154*/), 15034, 8},
	{EIF_NON_GENERIC(0x08F9 /*1148*/), 15035, 16},
};
void Init1013(void)
{
