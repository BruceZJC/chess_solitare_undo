...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1588, Current, 0, 3, 15188);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1588, Current, 15188);
	{
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1588, Current, 3, 3, 15189);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1588, Current, 15189);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1588, Current, 2, 3, 15190);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1588, Current, 15190);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("nb_positive", EX_PRE);
