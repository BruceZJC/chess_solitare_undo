...
extern EIF_TYPED_VALUE F1202_10645(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1202_10644 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1201, Current, 0, 0, 17283);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1201, Current, 17283);
	RTIV(Current, RTAL);
...
body:;
	...
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8138, dtype))(Current)).it_b);
...
EIF_TYPED_VALUE F1202_10645 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1201, Current, 0, 1, 17284);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1201, Current, 17284);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x04000000, 1,0); /* Result */
