...
extern void F1428_13644(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1428_13645(EIF_REFERENCE);
static EIF_TYPED_VALUE F1428_13646_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1428_13646(EIF_REFERENCE);
...
void F1428_13644 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1427, Current, 0, 1, 20026);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1427, Current, 20026);
	RTCC(arg1, 1427, l_feature_name, 1, RTWCT(9329, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1428_13645 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1427, Current, 0, 0, 20027);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
static EIF_TYPED_VALUE F1428_13646_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1428_13646 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9329, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1428_13646_body (Current)).it_r;
