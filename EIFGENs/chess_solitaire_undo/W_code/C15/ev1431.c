...
static EIF_TYPED_VALUE F1431_13657_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1431_13657(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1431_13658(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1431_13657_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1430, Current, 0, 0, 20036);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1430, Current, 20036);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1431_13657 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9329, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1431_13657_body (Current)).it_r;
...
EIF_TYPED_VALUE F1431_13658 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1430, Current, 0, 0, 20037);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1430, Current, 20037);
	RTIV(Current, RTAL);
	RTHOOK(1);
