...
static EIF_TYPED_VALUE F1451_14009_body(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1451_14009_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1451_14009 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9329, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1451_14009_body (Current)).it_r;
