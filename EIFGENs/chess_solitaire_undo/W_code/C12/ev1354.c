...
extern void F1354_12450(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1354_12451(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1354_12452(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1354_12453(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1354_12454(EIF_REFERENCE);
extern void F1354_12455(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1354_12456(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1354_12457(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1354_12458(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1354_12459(EIF_REFERENCE);
extern void F1354_12460(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F1354_12464(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1354_12465(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1354_12466(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1354_12467(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1354_12468(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1354_12469(EIF_REFERENCE);
extern void F1354_12470(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1354_12471(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1354_12472(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1354_12473(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1354_12474(EIF_REFERENCE);
extern void F1354_12475(EIF_REFERENCE);
static EIF_TYPED_VALUE F1354_12476_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1354_12476(EIF_REFERENCE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1353, Current, 0, 1, 19054);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1353, Current, 19054);
	RTCC(arg1, 1353, l_feature_name, 1, RTWCT(9329, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		tr1 = *(EIF_REFERENCE *)(Current + RTWA(9503, dtype));
		...
		tr4_1 = *(EIF_REAL_32 *)(Current + RTWA(9506, dtype));
		...
		tr4_1 = *(EIF_REAL_32 *)(Current + RTWA(9505, dtype));
		tr4_2 = (EIF_REAL_32) (((EIF_INTEGER_32) 0L));
		if ((EIF_BOOLEAN) eif_is_equal_real_32 (tr4_1, tr4_2)) {
			RTCK;
		} else {
		...
		tr4_1 = *(EIF_REAL_32 *)(Current + RTWA(9504, dtype));
		tr4_2 = (EIF_REAL_32) (((EIF_INTEGER_32) 0L));
		if ((EIF_BOOLEAN) eif_is_equal_real_32 (tr4_1, tr4_2)) {
			RTCK;
		} else {
...
/* {EV_COLOR_IMP}.make */
void F1354_12450 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1353, Current, 0, 0, 19055);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1353, Current, 19055);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 9503, 0xF80000EE, 0); /* name */
...
EIF_TYPED_VALUE F1354_12451 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL32;
	r.it_r4 = *(EIF_REAL_32 *)(Current + RTWA(9506,Dtype(Current)));
	return r;
}


/* {EV_COLOR_IMP}.green */
EIF_TYPED_VALUE F1354_12452 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL32;
	r.it_r4 = *(EIF_REAL_32 *)(Current + RTWA(9505,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F1354_12453 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL32;
	r.it_r4 = *(EIF_REAL_32 *)(Current + RTWA(9504,Dtype(Current)));
	return r;
}


/* {EV_COLOR_IMP}.name */
EIF_TYPED_VALUE F1354_12454 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1354_12455 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r4
	...
	RTEAA(l_feature_name, 1353, Current, 0, 1, 19060);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1353, Current, 19060);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 9506, 0x18000000, 1); /* red */
	*(EIF_REAL_32 *)(Current + RTWA(9506, dtype)) = (EIF_REAL_32) arg1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 9502, 0x10000000, 1); /* red_16_bit */
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(9502, dtype)) = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		...
		tr4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9499, dtype))(Current)).it_r4);
...
void F1354_12456 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r4
	...
	RTEAA(l_feature_name, 1353, Current, 0, 1, 19061);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1353, Current, 19061);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("within_range", EX_PRE);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 9505, 0x18000000, 1); /* green */
	*(EIF_REAL_32 *)(Current + RTWA(9505, dtype)) = (EIF_REAL_32) arg1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 9501, 0x10000000, 1); /* green_16_bit */
	tr4_1 = (EIF_REAL_32) (((EIF_INTEGER_32) 65535L));
	tr1 = RTLN(eif_new_type(209, 0x00).id);
	*(EIF_REAL_32 *)tr1 = (EIF_REAL_32) (arg1 * tr4_1);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4311, "rounded", tr1))(tr1)).it_i4);
...
void F1354_12457 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r4
	...
	RTEAA(l_feature_name, 1353, Current, 0, 1, 19062);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1353, Current, 19062);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 9504, 0x18000000, 1); /* blue */
	*(EIF_REAL_32 *)(Current + RTWA(9504, dtype)) = (EIF_REAL_32) arg1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 9500, 0x10000000, 1); /* blue_16_bit */
	tr4_1 = (EIF_REAL_32) (((EIF_INTEGER_32) 65535L));
	tr1 = RTLN(eif_new_type(209, 0x00).id);
	*(EIF_REAL_32 *)tr1 = (EIF_REAL_32) (arg1 * tr4_1);
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4311, "rounded", tr1))(tr1)).it_i4);
	*(EIF_INTEGER_32 *)(Current + RTWA(9500, dtype)) = (EIF_INTEGER_32) ti4_1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
void F1354_12458 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1353, Current, 0, 1, 19063);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1353, Current, 19063);
...
EIF_TYPED_VALUE F1354_12459 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1353, Current, 0, 0, 19064);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9487, dtype))(Current)).it_i4);
	...
	if (RTAL & CK_ENSURE) {
		...
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8514, 1248))(Current)).it_i4);
...
void F1354_12460 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1353, Current, 1, 1, 19065);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9494, dtype))(Current, ui4_1x);
	RTHOOK(4);
	...
	RTHOOK(12);
	ui4_1 = (EIF_INTEGER_32) (loc1 * ((EIF_INTEGER_32) 257L));
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9496, dtype))(Current, ui4_1x);
	if (RTAL & CK_ENSURE) {
		RTHOOK(13);
...
EIF_TYPED_VALUE F1354_12461 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1353, Current, 0, 0, 19066);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1353, Current, 19066);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	tr4_1 = *(EIF_REAL_32 *)(Current + RTWA(9506, dtype));
	...
	*(EIF_REAL_32 *)tr1 = (EIF_REAL_32) (tr4_1 * tr4_2);
	...
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("within_range", EX_POST);
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8512, 1248))(Current)).it_i4);
		if ((EIF_BOOLEAN) ((EIF_BOOLEAN) (Result >= ((EIF_INTEGER_32) 0L)) && (EIF_BOOLEAN) (Result <= ti4_1))) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F1354_12462 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1353, Current, 0, 0, 19067);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1353, Current, 19067);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	tr4_1 = *(EIF_REAL_32 *)(Current + RTWA(9505, dtype));
...
EIF_TYPED_VALUE F1354_12463 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1353, Current, 0, 0, 19068);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1353, Current, 19068);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	tr4_1 = *(EIF_REAL_32 *)(Current + RTWA(9504, dtype));
...
void F1354_12464 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1353, Current, 0, 1, 19069);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1353, Current, 19069);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("within_range", EX_PRE);
...
EIF_TYPED_VALUE F1354_12467 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1354_12468 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
#define arg1 arg1x.it_i4
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("within_range", EX_PRE);
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8513, 1248))(Current)).it_i4);
		RTTE((EIF_BOOLEAN) ((EIF_BOOLEAN) (arg1 >= ((EIF_INTEGER_32) 0L)) && (EIF_BOOLEAN) (arg1 <= ti4_1)), label_1);
		RTCK;
		RTJB;
label_1:
...
body:;
	...
	*(EIF_REAL_32 *)(Current + RTWA(9506, dtype)) = (EIF_REAL_32) tr4_1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("red_assigned", EX_POST);
...
void F1354_12471 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1353, Current, 0, 1, 19076);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(9501, dtype)) = (EIF_INTEGER_32) arg1;
	...
	RTDBGAA(Current, dtype, 9505, 0x18000000, 1); /* green */
	tr4_1 = (EIF_REAL_32) ((EIF_REAL_64) ((EIF_REAL_64) (arg1) /  (EIF_REAL_64) (((EIF_INTEGER_32) 65535L))));
	*(EIF_REAL_32 *)(Current + RTWA(9505, dtype)) = (EIF_REAL_32) tr4_1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("green_assigned", EX_POST);
...
void F1354_12472 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1353, Current, 0, 1, 19077);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 9500, 0x10000000, 1); /* blue_16_bit */
	*(EIF_INTEGER_32 *)(Current + RTWA(9500, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 9504, 0x18000000, 1); /* blue */
	tr4_1 = (EIF_REAL_32) ((EIF_REAL_64) ((EIF_REAL_64) (arg1) /  (EIF_REAL_64) (((EIF_INTEGER_32) 65535L))));
	*(EIF_REAL_32 *)(Current + RTWA(9504, dtype)) = (EIF_REAL_32) tr4_1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		RTCT("blue_assigned", EX_POST);
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(9500, dtype));
		if ((EIF_BOOLEAN)(ti4_1 == arg1)) {
			RTCK;
		} else {
			RTCF;
...
void F1354_12473 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1353, Current, 1, 1, 19078);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(3);
	RTDBGAA(Current, dtype, 9502, 0x10000000, 1); /* red_16_bit */
	ti4_1 = *(EIF_INTEGER_32 *)(loc1 + RTVA(9502, "red_16_bit", loc1));
	*(EIF_INTEGER_32 *)(Current + RTWA(9502, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 9501, 0x10000000, 1); /* green_16_bit */
	ti4_1 = *(EIF_INTEGER_32 *)(loc1 + RTVA(9501, "green_16_bit", loc1));
	*(EIF_INTEGER_32 *)(Current + RTWA(9501, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 9500, 0x10000000, 1); /* blue_16_bit */
	ti4_1 = *(EIF_INTEGER_32 *)(loc1 + RTVA(9500, "blue_16_bit", loc1));
	*(EIF_INTEGER_32 *)(Current + RTWA(9500, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(6);
	RTDBGAA(Current, dtype, 9506, 0x18000000, 1); /* red */
	tr4_1 = *(EIF_REAL_32 *)(loc1 + RTVA(9506, "red", loc1));
	*(EIF_REAL_32 *)(Current + RTWA(9506, dtype)) = (EIF_REAL_32) tr4_1;
	RTHOOK(7);
	RTDBGAA(Current, dtype, 9505, 0x18000000, 1); /* green */
	tr4_1 = *(EIF_REAL_32 *)(loc1 + RTVA(9505, "green", loc1));
	*(EIF_REAL_32 *)(Current + RTWA(9505, dtype)) = (EIF_REAL_32) tr4_1;
	RTHOOK(8);
	RTDBGAA(Current, dtype, 9504, 0x18000000, 1); /* blue */
	tr4_1 = *(EIF_REAL_32 *)(loc1 + RTVA(9504, "blue", loc1));
	*(EIF_REAL_32 *)(Current + RTWA(9504, dtype)) = (EIF_REAL_32) tr4_1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(9);
...
/* {EV_COLOR_IMP}.delta */
EIF_TYPED_VALUE F1354_12474 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1353, Current, 0, 0, 19079);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1354_12475 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1353, Current, 0, 0, 19080);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
static EIF_TYPED_VALUE F1354_12476_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1353, Current, 0, 0, 19081);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1354_12476 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9329, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1354_12476_body (Current)).it_r;
