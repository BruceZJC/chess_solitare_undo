...
extern EIF_TYPED_VALUE F1461_14078(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1461_14081(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1461_14082_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1461_14082(EIF_REFERENCE);
...
/* {EV_TEXT_I}.search */
EIF_TYPED_VALUE F1461_14078 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1460, Current, 0, 2, 20319);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1461_14081 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1460, Current, 0, 1, 20320);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1460, Current, 20320);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {EV_TEXT_I}.interface */
static EIF_TYPED_VALUE F1461_14082_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1460, Current, 0, 0, 20321);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1460, Current, 20321);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1461_14082 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9329, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1461_14082_body (Current)).it_r;
