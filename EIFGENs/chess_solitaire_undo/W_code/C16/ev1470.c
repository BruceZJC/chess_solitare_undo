...
extern void F1470_14304(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1470_14305(EIF_REFERENCE);
static EIF_TYPED_VALUE F1470_14306_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1470_14306(EIF_REFERENCE);
...
void F1470_14304 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1469, Current, 0, 1, 20511);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1469, Current, 20511);
	RTCC(arg1, 1469, l_feature_name, 1, RTWCT(9329, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1470_14305 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1469, Current, 1, 0, 20512);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1469, Current, 20512);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9324, 1468))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
static EIF_TYPED_VALUE F1470_14306_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1469, Current, 0, 0, 20513);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1469, Current, 20513);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1470_14306 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9329, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1470_14306_body (Current)).it_r;
