...
extern void F1459_14059(EIF_REFERENCE);
static EIF_TYPED_VALUE F1459_14060_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1459_14060(EIF_REFERENCE);
extern void F1459_16509(EIF_REFERENCE, int);
...
void F1459_14059 (EIF_REFERENCE Current)
{
	GTCX
...
static EIF_TYPED_VALUE F1459_14060_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1458, Current, 0, 0, 20311);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1459_14060 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9329, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1459_14060_body (Current)).it_r;
...
void F1459_16509 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1458, Current, 0, 16508);
	RTSA(dtype);
	RTME(dtype, 0);
