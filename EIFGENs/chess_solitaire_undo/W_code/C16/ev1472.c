...
extern void F1472_14327(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1472_14328(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F1472_14332(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1472_14327 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1471, Current, 0, 1, 20535);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1471, Current, 20535);
	RTCC(arg1, 1471, l_feature_name, 1, RTWCT(9329, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1472_14328 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1471, Current, 0, 0, 20536);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1471, Current, 20536);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1471, Current, 0, 0, 20537);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1471, Current, 20537);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9324, 1470))(Current);
	RTHOOK(2);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1471, Current, 0, 0, 20538);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1471, Current, 20538);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1471, Current, 0, 0, 20539);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1471, Current, 20539);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1472_14332 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1471, Current, 0, 1, 20540);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1471, Current, 20540);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x40000000, 1,0); /* Result */
	up1 = arg1;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1471, Current, 0, 0, 20541);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1471, Current, 20541);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x40000000, 1,0); /* Result */
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10072, dtype))(Current)).it_p);
...
static EIF_TYPED_VALUE F1472_14334_body (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1471, Current, 0, 0, 20542);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1471, Current, 20542);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
