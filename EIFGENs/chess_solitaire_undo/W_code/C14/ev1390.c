...
extern void F1390_13205(EIF_REFERENCE);
static EIF_TYPED_VALUE F1390_13207_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1390_13207(EIF_REFERENCE);
...
void F1390_13205 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1389, Current, 0, 0, 19685);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1389, Current, 19685);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		tb1 = '\01';
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10092, dtype))(Current)).it_b);
		if ((EIF_BOOLEAN) !tb2) {
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10091, dtype))(Current)).it_b);
			tb1 = tb2;
		}
		RTTE(tb1, label_1);
		RTCK;
...
static EIF_TYPED_VALUE F1390_13207_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1390_13207 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9329, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1390_13207_body (Current)).it_r;
