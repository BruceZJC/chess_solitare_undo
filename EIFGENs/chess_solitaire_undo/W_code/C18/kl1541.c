...
extern EIF_TYPED_VALUE F1541_15611(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1541_15612(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1541_15611 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_CHAR8;
...
EIF_TYPED_VALUE F1541_15612 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1541_15613 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1540, Current, 0, 0, 21670);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1540, Current, 21670);
	RTIV(Current, RTAL);
