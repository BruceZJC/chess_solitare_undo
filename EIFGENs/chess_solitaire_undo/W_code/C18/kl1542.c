...
extern void F1542_15614(EIF_REFERENCE);
extern void F1542_15615(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1542_15616(EIF_REFERENCE);
...
void F1542_15614 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1541, Current, 5, 0, 21671);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1541, Current, 21671);
	RTIV(Current, RTAL);
...
void F1542_15615 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1541, Current, 0, 0, 21672);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1542_15616 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1542_15616,21674,RTMS_EX_H("\015\012",2,3338));
}

void EIF_Minit1542 (void)
{
	GTCX
	RTOTS (15616,F1542_15616)
}
