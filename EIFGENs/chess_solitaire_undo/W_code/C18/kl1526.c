...
extern EIF_TYPED_VALUE F1526_15313(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1526_15313 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1525, Current, 0, 0, 21431);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1525, Current, 21431);
	RTIV(Current, RTAL);
	RTHOOK(1);
