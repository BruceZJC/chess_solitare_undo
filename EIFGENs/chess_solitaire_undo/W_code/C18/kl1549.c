...
extern EIF_TYPED_VALUE F1549_15846(EIF_REFERENCE);
...
RTOID (F1549_15846)
EIF_TYPED_VALUE F1549_15846 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F1549_15846);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 1548, Current, 0, 0, 21856);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1548, Current, 21856);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
