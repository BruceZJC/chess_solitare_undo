...
extern void F1536_15579(EIF_REFERENCE);
extern void F1536_15580(EIF_REFERENCE);
...
void F1536_15579 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1535, Current, 0, 0, 21642);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1535, Current, 21642);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1536_15580 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1535, Current, 0, 0, 21643);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1535, Current, 21643);
	RTIV(Current, RTAL);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(11408, dtype))(Current)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
