...
extern EIF_TYPED_VALUE F1532_15500(EIF_REFERENCE);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1531, Current, 0, 0, 21580);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1531, Current, 21580);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(11508, "is_current_file_system", Result))(Result)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1531, Current, 0, 0, 21581);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1531, Current, 21581);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F1532_15500)
EIF_TYPED_VALUE F1532_15500 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1531, Current, 0, 0, 21579);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1531, Current, 21579);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (15497,F1532_15497)
	RTOTS (15498,F1532_15498)
	RTOTS (15499,F1532_15499)
	RTOTS (15500,F1532_15500)
}
